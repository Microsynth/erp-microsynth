...
jinja = {
    "methods": [
        "microsynth.microsynth.jinja.get_price_list_rate",
        "microsynth.microsynth.jinja.get_destination_classification",
        "microsynth.microsynth.portfolio.get_yearly_order_sum",
        "microsynth.microsynth.portfolio.get_sales_volume",
        "microsynth.microsynth.portfolio.get_sales_qty",
        "microsynth.microsynth.portfolio.get_product_type",
        "microsynth.qms.doctype.qm_training_record.qm_training_record.get_training_records",
        "microsynth.qms.doctype.qm_review.qm_review.get_qm_reviews",
        "microsynth.qms.doctype.qm_document.qm_document.get_valid_appendices",
        "microsynth.qms.doctype.qm_nonconformity.qm_nonconformity.get_corrections",
        "microsynth.qms.doctype.qm_nonconformity.qm_nonconformity.get_corrective_actions",
        "microsynth.qms.doctype.qm_nonconformity.qm_nonconformity.get_effectiveness_checks",
        "microsynth.qms.doctype.qm_nonconformity.qm_nonconformity.get_qm_changes",
        "microsynth.qms.doctype.qm_nonconformity.qm_nonconformity.get_nc_attachments",
        "microsynth.qms.doctype.qm_change.qm_change.get_cc_impact_assessments",
        "microsynth.qms.doctype.qm_change.qm_change.get_cc_actions",
        "microsynth.qms.doctype.qm_change.qm_change.get_cc_effectiveness_checks",
        "microsynth.qms.doctype.qm_change.qm_change.get_qm_decisions",
        "microsynth.qms.doctype.qm_change.qm_change.get_cc_attachments",
        "microsynth.microsynth.utils.get_yearly_order_volume",
        "microsynth.microsynth.payment_reminder.get_html_message",
        "microsynth.microsynth.utils.fetch_quotation",
        "microsynth.microsynth.jinja.xml_normalize",
        "microsynth.microsynth.purchasing.get_customer_id_from_supplier",
        "microsynth.microsynth.payment_reminder.get_all_outstanding_invoices",
        "microsynth.microsynth.utils.get_webshop_services",
        "microsynth.microsynth.webshop.get_transactions",
        "microsynth.microsynth.utils.fetch_intercompany_dns_for_sos"
    ]
}
...
doc_events = {
    ...
    "Delivery Note": {
        ...
        "on_submit": "microsynth.microsynth.credits.delivery_note_on_submit",
    },
    "Purchase Order": {

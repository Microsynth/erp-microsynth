...
def get_columns():
    return [
        ...
        {"label": "Instrument ID", "fieldname": "document_name", "fieldtype": "Link", "options": "QM Instrument", "width": 90},

        # QM Instrument fields
        {"label": "Instrument Name", "fieldname": "instrument_name", "fieldtype": "Data", "width": 160},
        {"label": "Instrument Status", "fieldname": "instrument_status", "fieldtype": "Data", "width": 120},
        {"label": "Instrument Class", "fieldname": "instrument_class", "fieldtype": "Data", "width": 115},
        {"label": "Regulatory Classification", "fieldname": "regulatory_classification", "fieldtype": "Data", "width": 155},

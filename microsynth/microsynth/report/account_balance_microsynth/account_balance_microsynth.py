...
def get_data(filters=None):
    data = []
    for account in ['1070 - stripe - BAL', '1090 - Transferkonto CHF (Geld unterwegs) - BAL', '1091 - Transferkonto USD (Geld unterwegs) - BAL', '1092 - Transferkonto EUR (Geld unterwegs) - BAL', '1590 - Durchlaufende Posten - GOE', '1591 - Durchlaufkonto Eingangsrechnungen - GOE']:

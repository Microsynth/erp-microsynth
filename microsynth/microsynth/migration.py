...
def export_customers(filename, from_date):
    ...
    for d in data:       
        ...
        row = CUSTOMER_HEADER_FIELDS.format(
            replaceNone(person_id=d['person_id']),
            replaceNone(customer_id=d['customer_id']),
            replaceNone(customer_name=d['customer_name']),
            replaceNone(first_name=d['first_name']),
            replaceNone(last_name=d['last_name']),
            replaceNone(email=d['email']),
            replaceNone(address_line1=d['address_line1']),
            replaceNone(pincode=d['pincode']),
            replaceNone(city=d['city']),
            replaceNone(institute=d['institute']),
            replaceNone(department=d['department']),
            replaceNone(country=d['country']),
            replaceNone(DS_Nr=d['ds_nr']),
            replaceNone(address_type= "INV" if (d["address_type"]=="Billing") else "DEL"),
            replaceNone(vat_nr=d['vat_nr']),
            replaceNone(siret=d['siret']),
            replaceNone(currency=d['currency']),
            replaceNone(is_deleted=d['is_deleted']),
            replaceNone(default_discount=d['default_discount']),
            replaceNone(is_electronic_invoice=d['is_electronic_invoice']),
            replaceNone(receive_updates_per_email=d['receive_updates_per_email']),
            replaceNone(is_punchout_user=d['is_punchout_user']),
            replaceNone(punchout_identifier=d['punchout_identifier']),
            replaceNone(punchout_shop_id=d['punchout_shop_id']),
            replaceNone(room=d['room']),
            replaceNone(salutation=d['salutation']),
            replaceNone(title=d['title']),
            replaceNone(group_leader=d['group_leader']),
            replaceNone(email_cc=d['email_cc']),
            replaceNone(phone_number=d['phone_number']),
            replaceNone(phone_country=d['phone_country']),
            replaceNone(institute_key=d['institute_key']),
            replaceNone(newsletter_registration_state=d['newsletter_registration_state']),
            replaceNone(newsletter_registration_date=d['newsletter_registration_date']),
            replaceNone(newsletter_unregistration_date=d['newsletter_unregistration_date']),
            replaceNone(umr_nr=d['umr_nr']),
            replaceNone(invoicing_method=d['invoicing_method']),
            replaceNone(sales_manager=d['sales_manager']),
            replaceNone(ext_debitor_number=d['ext_debitor_number']),
            replaceNone(invoice_email=d['invoice_email']),
            replaceNone(phone=d['phone'])
        )
        f.write(row)
    # close file
    f.close()

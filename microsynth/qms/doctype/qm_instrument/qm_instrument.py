...
def import_qm_instruments(input_filepath, expected_line_length=23):
    """
    sudo bench execute microsynth.qms.doctype.qm_instrument.qm_instrument.import_qm_instruments --kwargs "{'input_filepath': '/mnt/erp_share/Migration/QM_Instruments/260813_Import_Instruments_3.5_v02.csv'}"
    """
